...
(W tym miejscu na GitHubie możesz wrzucić wcześniej zrobionego screena ze swojego terminala z wynikami).3. Cleanup:To safely remove the module from the kernel and stop packet inspection:Bashrmmod m14_ttl
